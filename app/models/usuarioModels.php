<?php
    ...
    class usuarioModels extends DB{
        ...
        public function registrarUsuarioModel(){
            ...
            if(
                ...
                $telefono == "" || $usuario == "" || $contrasena1 == "" || $contrasena2 == ""
            ){
                $alerta=[
                    "tipo" => "simple",
            ...
            if($contrasena1 != $contrasena2){
                $alerta=[
                    ...
                    "texto" => "Ambas contraseñas deben ser iguales para poder registrar el usuario",
                    "icono" => "error",
                    ];
                    return json_encode($alerta);
                    exit();
            ...
            )
            {
                ...
                if(!file_exists($dir_fotos)){ /*Comprueba si el directorio existe */
                ...
                /*Nombre de la foto */
                $foto= str_ireplace(" ","_", $nombre." ". $apellido);
            ...
            $registrar_usuario= $this-> guardarDatos('usuarios', $datos_registro_usuarios);
        ...
        /*Listar usuarios */
        public function listarUsuariosPaginador($pagina, $registros, $url, $busqueda, $orden = ""){
